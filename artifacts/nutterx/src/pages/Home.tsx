...
const WA_COMMUNITY = "https://chat.whatsapp.com/JsKmQMpECJMHyxucHquF15?mode=gi_t";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pt-16">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-28 sm:pt-28 sm:pb-36">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
              ...
              <button onClick={() => setLinkModal(WA_COMMUNITY)}
      ...
      {linkModal && <ExternalLinkModal url={linkModal} onClose={() => setLinkModal(null)} />}
    </div>
  );
}
